...
void input_init_env( retro_environment_t _environ_cb )
{
	...
	struct retro_input_descriptor desc[] =
	{
		...
		{ 0, RETRO_DEVICE_LIGHTGUN, 0, RETRO_DEVICE_ID_LIGHTGUN_OFFSCREEN_SHOT, "Shoot off-screen" },
		...
		{ 1, RETRO_DEVICE_LIGHTGUN, 0, RETRO_DEVICE_ID_LIGHTGUN_OFFSCREEN_SHOT, "Shoot off-screen" },
	...
	for ( unsigned iplayer = 0; iplayer < players; ++iplayer )
	{
		...
		case RETRO_DEVICE_SS_GUN:

			{
				...
				offscreen_shot = input_state_cb( iplayer, RETRO_DEVICE_LIGHTGUN, 0, RETRO_DEVICE_ID_LIGHTGUN_OFFSCREEN_SHOT );
